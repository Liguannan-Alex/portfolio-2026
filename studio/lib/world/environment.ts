...
export async function makeEnvironment(scene:THREE.Scene){
 ...
 const foliageMat=new THREE.MeshLambertMaterial({color:'#ffffff',alphaMap:leaf,alphaTest:.46,side:THREE.DoubleSide});materials.push(foliageMat);
